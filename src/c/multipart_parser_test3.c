...
int main() {
  ...
  char * test_data_07 = "\r\n";
  char test_data_08[(DATA_BUFFER_SIZE * 4) + 23]; // binary data
  memset(test_data_08, 'a', (DATA_BUFFER_SIZE * 4) + 23);
  test_data_08[(DATA_BUFFER_SIZE * 4) + 22] = 0;
  char * test_data_09 = "\r\n";
  char * test_data_10 = "-----------------------------204250758710714497121462520684\r\n";

 fprintf (stdout,"\nRunning unit test, large data sets \n");
